...
> **Personal note:** I tested this on Blender 4.1 and Python 3.11 — works great. The uv install step is mandatory; skipping it will cause silent failures that are annoying to debug.
